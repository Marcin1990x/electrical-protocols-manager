...
public class SecondMeasurementEntry extends MeasurementEntry {
    ...
    public SecondMeasurementEntry(int commonField1, int commonField2, int commonField3,
